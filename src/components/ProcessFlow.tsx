    ...
    <section id="process" className="section-padding bg-background" ref={ref}>
      <div className="container-custom">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-green-500 via-green-600 to-yellow-500 hidden md:block transform -translate-x-1/2" />
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Step Number Circle */}
              <div className="hidden md:flex w-16 h-16 rounded-full bg-white border-4 border-background items-center justify-center z-10 flex-shrink-0">
          ...
          <div className="md:hidden absolute left-8 top-0 bottom-0 flex flex-col justify-between py-16">
            {steps.slice(0, -1).map((_, index) => (
              <ArrowDown
                key={index}
                className="w-5 h-5 text-green-500 transform -translate-x-1/2 ml-0.5"
              />
            ))}
          </div>
        </div>
        ...
        >
          <div className="bg-gradient-to-r from-green-500 to-yellow-500 rounded-2xl p-8 text-center">
